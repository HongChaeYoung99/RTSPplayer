...
bool createProcess(LPSTR strProcessName) {
	...
	if (CreateProcess(NULL, strProcessName, NULL, NULL, FALSE, 0, NULL, NULL, &StartupInfo, &ProcessInfo))
		return true;
	else
		return false;
}
...
void CMFCApplicationDlg::OnBnClickedButton1()
{
	...
	if (createProcess(_T("..\\Runtime\\RTSP_playerd.exe")))
		OutputDebugString("실행성공");
	else
		OutputDebugString("실행실패");
}
